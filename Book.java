...
public class Book {
   ...
   * @return true if and only if the object is a Book which shares all attributes with this one,
   *         false otherwise.
   */
  @Override
  public boolean equals(Object o) {
    if (!(o instanceof Book)) {
      ...
      if (this.compareTo((Book) o, Attribute.ID) != 0
          || this.compareTo((Book) o, Attribute.TITLE) != 0
          || this.compareTo((Book) o, Attribute.AUTHOR) != 0
          || this.compareTo((Book) o, Attribute.PAGECOUNT) != 0) {
        return false;
      }
      return true;
    }
